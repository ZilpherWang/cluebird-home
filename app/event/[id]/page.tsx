...
import OrderBook from '@/components/events/orderBook'
import EventChart from '@/components/events/eventChart'
import MarketSummary from '@/components/events/marketSummary'
import Rules from '@/components/events/rules'    
import Comments from '@/components/events/comments' 
import Holders from '@/components/events/holders'
import Activity from '@/components/events/activity'
import Related from '@/components/events/related'
import Trade from '@/components/events/trade'
